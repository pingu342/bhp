...
def parse_options():
    ...
    parser.add_argument('-g', '--gateway_ip', required=True)
    parser.add_argument('-c', '--packet_count', required=True)
    args = parser.parse_args()
    return (args.interface, args.target_ip, args.gateway_ip, int(args.packet_count))
...
interface, target_ip, gateway_ip, packet_count = parse_options()
...
if gateway_mac is None:
    ...
    print "[*] Gateway %s is ath %s" % (gateway_ip, gateway_mac)
