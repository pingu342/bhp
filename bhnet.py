...
def usage():
    ...
    print "bhnet.py -t 192.168.0.1 -p 5555 -l -u /path/to/target.exe"
...
def main():
    ...
    # 接続を待機する? それとも標準入力からのデータを受け取って送信する?
...
def client_handler(client_socket):
    ...
    if len(upload_destination):
        ...
        # すべてのデータを読み取り、指定されたファイルにデータを書き込む
        file_buffer = ""
